...
interface NodeOmxPlayerStatic {
	 ...
	 */
	(source?: String, output?: String, loop?: Boolean, initialVolume?: Number, position?: String, showOsd?: Boolean): NodeOmxPlayer;
}
...
interface NodeOmxPlayer extends Event {
	 ...
	 * @param initialVolume (optional): The initial volume, omxplayer will start with this value (in millibels). If left blank will default to 0.
	 */
	newSource(source: String, output?: String, loop?: Boolean, initialVolume?: Number, position?: String, ): void;
